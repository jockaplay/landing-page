    ...
    return (
        <header className="fixed w-full overflow-hidden bg-white flex h-16 justify-center md:justify-between font-bold z-10 drop-shadow-sm">
            <ul className="hidden md:flex">
                ...
                <li><a className="transition ease-out duration-170 flex px-10 items-center h-full hover:scale-125 hover:text-purple-700" href="#">Projetos</a></li>
            </ul>
            ...
            <ul className="hidden md:flex">
                <li><a className="transition ease-out duration-170 flex px-10 items-center h-full hover:scale-125 hover:text-purple-700" href="#">Sobre</a></li>
